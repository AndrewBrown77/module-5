...
function handleDeleteTask(event) {
  ...
  //     // You will need to identify the task element based on its ID and remove it from the task board     // This may involve finding the task element by its ID and removing it from the DOM
}
...
$(".task").draggable({
  // Initialize jQuery UI's draggable and droppable features
  revert: "invalid",
  snap: true,
});
